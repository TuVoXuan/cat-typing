...
export default function Home() {
  ...
  return (
    <>
      <div className="xl:hidden dark bg-primary h-screen w-full py-8">
        <Header />
        <div className="flex flex-col flex-1 items-center justify-center mt-10 px-3">
          <h2 className="text-sub">
            Sorry our web is not support in mobile and tablet
          </h2>
          <h2 className="text-sub">Please access website in your laptop</h2>
        </div>
      </div>
      <div className="hidden xl:block dark bg-primary h-screen w-full py-8">
        <Header />
